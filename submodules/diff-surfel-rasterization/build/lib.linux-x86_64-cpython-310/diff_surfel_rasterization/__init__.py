...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        #print("geomBuffer")
        #print(geomBuffer.shape)
        #print(geomBuffer[6523*3])
        #for i in range(0,350,1):
        #    for j in range(700):
         #       if math.isnan(color[0,i,j]):
        #            print(i,j)
    ...
    def backward(ctx, grad_out_color, grad_radii, grad_depth):
        ...
        #print("cov3Ds_precomp")
        #print(cov3Ds_precomp[9734])
        #for i in range(350):
        #    print(grad_out_color[0,i,350])
