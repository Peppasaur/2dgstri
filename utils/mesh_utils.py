...
class GaussianExtractor(object):
    def __init__(self, gaussians, triangles, render, pipe, bg_color=None):
        """
    ...
    def reconstruction(self, viewpoint_stack):
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            print("trisz")
            print(self.triangles.get_facets().shape[0])
            render_pkg = self.render(viewpoint_cam, self.gaussians, self.triangles)
